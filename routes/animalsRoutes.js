...
animalsRouter.post("/:id/edit/new_description", animalsController.animalsNewDescriptionPOST)
animalsRouter.get("/:id/facts/:fact_id/delete", animalsController.animalsFactsDELETE)
animalsRouter.get("/:id/descriptions/:description_id/delete", animalsController.animalsDescriptionDELETE)
